...
def distribute_global_model():
    ...
    print(f"\n[SERVIDOR] Distribuyendo Modelo Global plano a Gateways (Ronda {current_round})...")
...
async def receive_gateway_model(data: dict):
    ...
    print(f"\n[SERVIDOR] Pesos planos recibidos de '{gateway_id}' | {num_samples} muestras | Acc: {accuracy:.2%}")
            ...
            options: {
                ...
                scales: {
                    ...
                    y: {
                        ...
                        grid: { color: '#334155' },
                        ticks: { color: '#94a3b8' },
                        title: { display: true, text: 'Tiempo de serializacion/parseo (ms)', color: '#f8fafc' }
                    },
                    y1: {
                        type: 'linear',
                        position: 'right',
