...
\usepackage[table]{xcolor}     % Color de soporte (tablas: \rowcolors, figuras).
\usepackage[final]{microtype}  % Tipografia: protrusion + expansion para
                               % evitar lineas que se desbordan al margen.
