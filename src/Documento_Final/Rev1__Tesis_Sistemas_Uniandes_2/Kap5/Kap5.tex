...
Muestras por ronda (por gateway) & 30 \\
...
\begin{enumerate}[noitemsep, topsep=0pt]
    \item El modelo federado converge en $\sim$20--30 rondas hacia un rango operativo de $\sim$90--95\% de accuracy, lo que representa un \textbf{gap} frente a los modelos centralizados más precisos. Este gap es atribuible a: (i) el tamaño reducido del buffer local (30 muestras vs.\ 256\,276), (ii) la distribución non-IID de los datos entre nodos, y (iii) la función heurística de etiquetado que introduce ruido respecto a las etiquetas reales.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{images/Resultados/Completo/weight_magnitude_trends.png}
...
\begin{tabular}{l  c c c c c c}
\toprule
\textbf{Variante}  & \textbf{Acc.\ final} & \textbf{Loss final} & \textbf{Ronda (s)} & \textbf{GW p95 (ms)} & \textbf{Srv dec p95 (ms)} & \textbf{Overhead (B)} \\
\midrule
\texttt{CNN\_ASCON\_FOG}    & \textbf{0.9750} & \textbf{0.0910} & 58.61 & 4.53 & 37.47 & 1098 \\
\texttt{CNN\_ASCON\_NoFOG}   & 0.9604 & 0.1040 & 58.97 & 4.55 & 24.46 & 1049 \\
\texttt{CNN\_PLAIN\_FOG}    & 0.9444 & 0.1190 & 54.86 & 0.16 &  0.00 &    0 \\
\texttt{CNN\_PLAIN\_NoFOG}   & 0.9389 & 0.1363 & 52.02 & 0.15 &  0.00 &    0 \\
\texttt{RN\_ASCON\_FOG}    & 0.9633 & 0.1124 & 71.13 & 4.37 & 50.47 & 1084 \\
\texttt{RN\_ASCON\_NoFOG}   & 0.9381 & 0.1545 & 72.91 & 4.65 & 26.69 & 1050 \\
\texttt{RN\_PLAIN\_FOG}     & 0.9000 & 0.2199 & 67.14 & 0.16 &  0.00 &    0 \\
\texttt{RN\_PLAIN\_NoFOG}    & 0.9298 & 0.1581 & 51.01 & 0.17 &  0.00 &    0 \\
\midrule
\rowcolor{white}\textbf{Promedio global}  & \textbf{0.9437} & \textbf{0.1383} & \textbf{61.36} & \textbf{2.34} & \textbf{17.39} & \textbf{636} \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{tabular}{l r r}
\toprule
\textbf{Componente} & \textbf{Con ASCON (4 var.)} & \textbf{Sin ASCON (4 var.)} \\
\midrule
