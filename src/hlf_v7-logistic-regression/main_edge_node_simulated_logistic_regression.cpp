// =====================================================================
// main_edge_node_simulated_logistic_regression.cpp — ESP32-S3 Edge Node (Logistic Regression)
// =====================================================================
...
const String CLIENT_ID = "esp32_edge_simulated_logistic_regression";
...
void loop() {
  ...
  Serial.print("[SIM][Logistic Regression] pred=");
