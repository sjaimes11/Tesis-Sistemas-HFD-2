...
GATEWAY_ID = "gateway_logistic_regression"
...
metrics = AsconMetrics("gateway_logistic_regression")
...
def on_connect(client, userdata, flags, rc):
    print(f"[GATEWAY] MQTT conectado rc={rc} | modelo=Logistic Regression")
...
if __name__ == "__main__":
    client = mqtt.Client(client_id="gateway_hfl_logistic_regression")
