...
GATEWAY_ID = "gateway_decision_tree"
...
metrics = AsconMetrics("gateway_decision_tree")
...
def on_connect(client, userdata, flags, rc):
    print(f"[GATEWAY] MQTT conectado rc={rc} | modelo=Decision Tree")
...
if __name__ == "__main__":
    client = mqtt.Client(client_id=f"gateway_hfl_fog_decision_tree")
