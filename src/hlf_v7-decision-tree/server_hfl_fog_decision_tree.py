...
<head>
    ...
    <title>server_hfl_decision_tree</title>
    <style>
        :root {
            --bg: #0b1220;
            --panel: #121a2b;
...
<body>
    <div class="wrap">
        <section class="hero">
            <h1>Servidor HFL - Decision Tree</h1>
        ...
        <section class="grid">
            <article class="card">
                ...
                <div class="value" id="service-name">server_hfl_decision_tree</div>
            </article>
            <article class="card">
                <div class="label">Modelo</div>
                <div class="value" id="model-name">Decision Tree</div>
            </article>
            <article class="card">
    ...
    <script>
            ...
            const rows = records.slice().reverse().map((record) => {
                return `
                    <tr>
                        ...
                        <td>${escapeHtml(record.model ?? 'Decision Tree')}</td>
                    </tr>
                `;
            }).join('');
        ...
        async function refresh() {
            try {
                ...
                document.getElementById('model-name').textContent = status.model ?? 'Decision Tree';
