// =====================================================================
// main_edge_node_simulated_decision_tree.cpp — ESP32-S3 Edge Node (Decision Tree)
// =====================================================================
...
const String CLIENT_ID = "esp32_edge_simulated_decision_tree";
...
void loop() {
  ...
  Serial.print("[SIM][Decision Tree] pred=");
