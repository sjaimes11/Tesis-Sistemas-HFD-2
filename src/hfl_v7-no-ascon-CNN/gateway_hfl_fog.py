...
IP_PC = os.environ.get("IP_PC", "192.168.1.18")
PORT_PC = os.environ.get("PORT_PC", "8001")
FOG_LEADER_IP = os.environ.get("FOG_LEADER_IP", "192.168.1.16")   # IP de la RPi líder (broker Fog MQTT)
FOG_PEER_IPS = _env_list("FOG_PEER_IPS", ["192.168.1.17"])  # IPs de las RPi peers (solo el líder las necesita)
...
X_train_buffer = []
Y_train_buffer = []
SAMPLES_PER_UPDATE = _env_int("SAMPLES_PER_UPDATE", 30)
