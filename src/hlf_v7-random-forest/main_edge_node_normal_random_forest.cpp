// =====================================================================
// main_edge_node_normal_random_forest.cpp — ESP32-S3 Edge Node (Random Forest)
// =====================================================================
...
const String CLIENT_ID = "esp32_edge_normal_random_forest";
...
void loop() {
  ...
  Serial.print("[NORMAL][Random Forest] pred=");
