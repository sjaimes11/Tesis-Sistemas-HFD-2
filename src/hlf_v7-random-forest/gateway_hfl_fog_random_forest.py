...
GATEWAY_ID = "gateway_random_forest"
...
metrics = AsconMetrics("gateway_random_forest")
...
def on_connect(client, userdata, flags, rc):
    print(f"[GATEWAY] MQTT conectado rc={rc} | modelo=Random Forest")
...
if __name__ == "__main__":
    client = mqtt.Client(client_id=f"gateway_hfl_fog_random_forest")
