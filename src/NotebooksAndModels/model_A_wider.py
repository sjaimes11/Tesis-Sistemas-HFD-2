"""
=============================================================================
 model_A_wider.py — MLP ANCHO: 128 → 64 → 6
 Hipótesis: más unidades capturan mejor las diferencias entre clases.
...
MODEL_NAME = "Model_A_Wider_128_64"

DATA_DIR = Path("/home/sajaimesp/Tesis_Sistemas/Data_Sets/Proyecto_Grado_DataSets")
EXPORT_DIR = Path("export_modelA"); EXPORT_DIR.mkdir(exist_ok=True)
...
# ====================== MODELO A: WIDER 128->64->6 ======================
print(f"\n{'='*50}\n {MODEL_NAME}\n MLP: {X_tr.shape[1]} -> 128 -> 64 -> {num_classes}\n{'='*50}")
...
hist = model.fit(X_tr, y_tr, validation_data=(X_val,y_val), epochs=60, batch_size=2048,
